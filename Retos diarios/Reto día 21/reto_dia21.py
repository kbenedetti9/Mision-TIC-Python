def control(asignado,registrado):
  ...
  for i in range(1,6):
    ...
    for j in range(0,30):
        ...
        if registrado[j][1] == i and asignado[j][1] == i:    
          if sumarLitros == True and sumarTiempos == True:
            totalEntregas +=1
            if asignado[j][3] >= registrado[j][3]:
              numEntregaATiempo+=1
  ...
  print("Para Id camión # 1 = {0} %".format(entregasATiempo1))
  print("Para Id camión # 2 = {0} %".format(entregasATiempo2))
  print("Para Id camión # 3 = {0} %".format(entregasATiempo3))
  print("Para Id camión # 4 = {0} %".format(entregasATiempo4))
  print("Para Id camión # 5 = {0} %".format(entregasATiempo5))
